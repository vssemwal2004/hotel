  ...
  return (
    <MainLayout>
            ...
            <div className="flex-1 p-8 md:p-12 flex flex-col justify-center relative">
              ...
              <div className="max-w-md mx-auto w-full">
                ...
                <div className="mt-8 text-center transform transition-all duration-300 hover:scale-[1.01]">
                  ...
                  <Link 
                    href="/auth/register" 
                    className="font-semibold text-red-600 hover:text-red-700 transition-all duration-300 transform hover:scale-105 inline-block"
                  >
                    Create account
                  </Link>
                </div>
      ...
      <style jsx>{`
        ...
        .shadow-3xl {
          box-shadow: 0 25px 50px -12px rgba(0, 0, 0, 0.25), 0 0 25px -5px rgba(249, 115, 22, 0.1);
        }
